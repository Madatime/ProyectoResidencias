...
public class TmpUpsertDocsR10 {
  public static void main(String[] args) throws Exception {
    ...
    try (Connection c=DriverManager.getConnection(url,"root","12345")) {
      upsert(c, 10, "ENTREGA_REPORTE_EMPRESA", "Entrega de Reporte.pdf", "ENTREGA_REPORTE_EMPRESA_R10.pdf", "CARGADO", "Documento cargado manualmente para expediente final.");
      upsert(c, 10, "OFICIO_ENTREGA_DIVISION", "9 Oficio de entrega de Reporte.pdf", "OFICIO_ENTREGA_DIVISION_R10.pdf", "CARGADO", "Documento cargado manualmente para expediente final.");
      try (PreparedStatement ps = c.prepareStatement("select id,idResidencia,tipoDocumento,nombreArchivo,rutaArchivo,estatus from documento_residencia where idResidencia=10 order by id")) {
